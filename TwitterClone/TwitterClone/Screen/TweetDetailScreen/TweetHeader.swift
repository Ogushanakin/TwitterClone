...
final class TweetHeader: UICollectionReusableView {
    ...
    private let captionLabel: UILabel = {
        ...
        label.text = "Some test caption from chandler for now"
        return label
    }()
    ...
    private lazy var statsView: UIView = {
        ...
        divider2.anchor(top: view.topAnchor, left: view.leftAnchor,
                        right: view.rightAnchor, paddingLeft: 8, height: 1.0)
    ...
    override init(frame: CGRect) {
        ...
        captionLabel.anchor(top: stack.bottomAnchor, left: leftAnchor,
        ...
        actionStack.anchor(top: statsView.bottomAnchor, paddingBottom: 12)
    }
